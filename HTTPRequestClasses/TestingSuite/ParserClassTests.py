...
class MyTestCase(unittest.TestCase):
    def test_MaryGrantDemographics(self):
        file_path = 'MaryGrant-ClinicalSummary.xml'
        maryDemographics = parser.createNewDemographicsInstance(file_path)
        assert(maryDemographics.getFilePath() == 'MaryGrant-ClinicalSummary.xml')
    ...
    def test_IsabellaJonesDemographics(self):
        ...
        assert(isabellaDemographics.getFilePath() == 'IsabellaJones-ReferralSummary.xml')
    ...
    def test_badFileType(self):
        file_path = 'Critical Review 1.docx'
